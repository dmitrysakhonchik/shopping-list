...
import by.diem.shoppinglist.services.UserRepresentation;
import by.diem.shoppinglist.services.UserService;
...
public class LoginController {
    ...
    public String registerNewUser(@Valid @ModelAttribute("user") UserRepresentation userRepresentation,
